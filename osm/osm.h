...
namespace osm {
  ...
  public:
    ...
    double Astar(const long n1,const long n2,const string &vehicle,list<long> &route,const bool ignoreExtra=false);
    double Astar(const long n1,const double lat2,const double lon2,const string &vehicle,list<long> &route,const bool ignoreExtra=false);
    double Astar(const double lat1,const double lon1,const long n2,const string &vehicle,list<long> &route,const bool ignoreExtra=false);
    double Astar(const double lat1,const double lon1,const double lat2,const double lon2,const string &vehicle,list<long> &route,const bool ignoreExtra=false);
