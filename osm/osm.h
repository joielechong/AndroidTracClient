...
namespace osm {
  ...
  public:
    ...
    inline ~Way() {}
	string output ();
	inline void store(osm_db::database& con){con.createWay(_id,_version);}
  ...
  public:
    ...
    inline ~Relation() {}
	string output ();
 	inline void store(osm_db::database& con){con.createRelation(_id,_version);}
  ...
  public:
	...
	string output ();
	inline void store(osm_db::database& con){con.createNode(_id,_version,_lat,_lon);}
