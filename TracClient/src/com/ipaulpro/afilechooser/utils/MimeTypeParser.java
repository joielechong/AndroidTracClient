...
public class MimeTypeParser {
	...
	private void addMimeTypeStart() {
		final String extension = mXpp.getAttributeValue(null, ATTR_EXTENSION);
		final String mimetype = mXpp.getAttributeValue(null, ATTR_MIMETYPE);
