...
public class Ticket {
	...
	public int create(final TracStart context) throws Exception {
		if (_ticknr != -1) {
	...
	public void update(String action, String comment, String veld, String waarde, final TracStart context) throws Exception {
			...
			public void run() {
				...
				try {
					if (_url != null) {
						...
						req.callJSONArray("ticket.update", _ticknr, cmt, _velden);
						actionLock.release();
						loadTicketData(context, null);
					}
				} catch (final JSONRPCException e) {
