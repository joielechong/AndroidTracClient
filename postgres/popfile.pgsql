...
create table popfile ( id serial primary key,
...
create table users ( id serial primary key,  -- unique ID for this user
...
create table buckets( id serial primary key, -- unique ID for this bucket
...
create table words(   id serial primary key, -- unique ID for this word
...
create table matrix( id serial primary key,   -- unique ID for this entry
...
create table user_template( id serial primary key,  -- unique ID for this entry
...
create table user_params( id serial primary key,    -- unique ID for this
                                                     -- entry
...
create table bucket_template( id serial primary key,  -- unique ID for this entry
                              name varchar(255),       -- the name of the
                                                       -- parameter
                              def varchar(255),        -- the default value for
                                                       -- the parameter
...
create table bucket_params( id serial primary key,    -- unique ID for this
                                                       -- entry
...
create table magnet_types( id serial primary key,  -- unique ID for this entry
...
create table magnets( id serial primary key,    -- unique ID for this entry
                      bucketid integer,          -- a bucket
...
create table history( id serial primary key,     -- unique ID for this entry
...
--
-- ---------------------------------------------------------------------------------------------
create or replace function tp_delete_bucket() returns trigger as
'
             begin
...
create trigger delete_bucket before delete
    on buckets for each row execute procedure tp_delete_bucket();
...
--
-- ---------------------------------------------------------------------------------------------
create or replace function tp_delete_user() returns trigger as
'
             begin
...
create trigger delete_user before delete
    on users for each row execute procedure tp_delete_user();
...
create or replace function tp_delete_magnet_type() returns trigger as
'
             begin
...
create trigger delete_magnet_type before delete
    on magnet_types for each row execute procedure tp_delete_magnet_type();
...
create or replace function tp_delete_user_template() returns trigger as
'
             begin
...
create trigger delete_user_template before delete
    on user_template for each row execute procedure tp_delete_user_template();
...
create or replace function tp_delete_bucket_template() returns trigger as
'
             begin
...
create trigger delete_bucket_template before delete
    on bucket_template for each row execute procedure tp_delete_bucket_template();
