...
//		tcLog.d(getClass().getName(),"isNull "+ column+" "+getPosition()+ " "+this);
		Ticket t = Tickets.ticketList.get(this.getPosition());
		return t == null;
	}
...
//		tcLog.d(getClass().getName(),"getColumnNames "+this);
	...
	@Override
	public int getCount() {
//		tcLog.d(getClass().getName(),"getCount -->"+ Tickets.getTicketCount()+" "+this);
...
//		tcLog.d(getClass().getName(),"getInt "+ column+" "+getPosition());
		...
		return Tickets.ticketList.get(this.getPosition()).getTicketnr();
	}
...
//		tcLog.d(getClass().getName(),"getShort "+ column+" "+getPosition());
	...
	@Override
	public String getString(int column) throws IllegalArgumentException {
