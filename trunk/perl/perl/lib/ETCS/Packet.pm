...
#
    ...
    $msg_trackpackets[ 44]=["NID_PACKET","Q_DIR","L_PACKET","NID_XUSER"];
    ...
    $msg_trackpacketnames[ 254] = "DEFAULT BALISE INFORMATION";
...

{
  ...
  BEGIN {
    ...
    $msg_trainpackets[  44]=["NID_PACKET","L_PACKET","NID_XUSER"];
  }
